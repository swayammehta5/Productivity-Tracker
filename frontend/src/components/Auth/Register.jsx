// not using beacuse of Google OAuth, but keeping for future use if needed
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">🎯 Productivity Tracker</h1>
          <p className="text-gray-600 dark:text-gray-400">Start your journey to better habits</p>
        </div>
