      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          >
            ...
            <span className="text-xl font-bold bg-gradient-to-r from-orange-600 to-amber-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
              ProductivityTracker
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2 ml-4">
              ...
              <button
                onClick={logout}
                className="group px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-xl font-medium shadow-lg transform hover:scale-105 hover:shadow-glass transition-all duration-300"
              >
                <span className="flex items-center space-x-2">
                  <span>🚪</span>
                  <span>Logout</span>
          ...
          {/* Mobile Menu Button */}
          <button
            className="lg:hidden inline-flex items-center justify-center p-3 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-gray-100/50 dark:hover:bg-gray-800/50 backdrop-blur-sm transition-all duration-300 transform hover:scale-105"
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-gray-200/50 dark:border-gray-700/50 py-4 animate-slide-up">
